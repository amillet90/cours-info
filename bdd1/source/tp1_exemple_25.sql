...
-- Editeur:  ctrl maj /    => commente / decommente
-- Terminal: [tab] : essaye de completer
-- Terminal: commande history
-- [Windows + [<-]   [->]]  : deplacement de fenetres


-- mysql --user=login --password=mdp --host=serveurmysql BDD_login

-- connexion avec un pc perso. avec le VPN de l IUT
-- mysql --user=login --password=secret --host=serveurmysql.iut-bm.univ-fcomte.fr  --database=BDD_login
